...
while victory == False and defeat == False:
    ...
    while direction not in options:
        ...
        if direction == "w":
            ...
            if snorlax_block == False:
                ...
                clean_screen()
                print("WASD para moverte\n■ = jugador\n¤ = entredadores contrincantes\n♪ = instrumento musical\n"
                      "╬ = curación\n Habilidades de pikachu:\n 1: Thunder Shock (ataque electrico [65 de poder])\n"
                      "2: Feint(ataque normal [reduce los aumentos de defensa]\n"
                      "3: Doble team (ataque normal [te da evasión contra un atanque])\n"
    ...
    #Pokemon combat
        ...
        if new_position == [27, 1]:  # vs Meltan (Rocío)
            clean_screen()
            print("Entrenadora Rocío te desafía.\nEnvía a Colgajo (Meltan).")
            # stats
            evasion = 0
            defense = 0
            ...
            clean_screen()
            print("Entrenador Eric te desafía.\nEnvía a Vaporeon.")
            # stats
            evasion = 0
            defense = 0
            ...
            clean_screen()
            print("Entrenador Caliebre desafía.\nEnvía a Politoed.")
            # stats
            evasion = 0
            ...
            clean_screen()
            print("Entrenador Rafa te desafía.\nEnvía a Forretress.")
            # stats
            evasion = 0
            charge = 0
            weight = 2
            ...
            clean_screen()
            print("Entrenador Pazos te desafía.\nEnvía a Primeape.")
            # stats
            evasion = 0
            fury = 1
            speed = 1
            ...
            clean_screen()
            print("Entrenador Alex te desafía.\nEnvía a Patodin (Sirfetchd).")
            # stats
            evasion = 0
            speed = 1
            fury = 1
